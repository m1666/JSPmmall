...
<div id="mainDiv">
    ...
    <form action="<%=updateUrl%>" method="post" onsubmit="return validateInsert()" enctype="multipart/form-data">
        <table border="1" cellpadding="5" cellspacing="0" bgcolor="#F2F2F2" width="100%">
            ...
            <td width="15%"><span id="titleMsg"></span></td>
            <td width="40%" rowspan="7"><div id="preview"><img src="/upload/goods/${goods.photo}"></div></td>    
            </tr>
            <tr onmouseover="changeColor(this,'#FFFFFF')"onmouseout="changeColor(this,'#F2F2F2')">
                <td width="15%">所属分类：</td>
                <td>
            ...
            <tr onmouseover="changeColor(this,'#FFFFFF')"onmouseout="changeColor(this,'#F2F2F2')">
                <td colspan="4">
                    <textarea id="note" name="note" cols="100" rows="5" onblur="validateNote()">${goods.note}</textarea>
                </td>
            </tr>
            <tr onmouseover="changeColor(this,'#FFFFFF')"onmouseout="changeColor(this,'#F2F2F2')">
                <td colspan="4">
