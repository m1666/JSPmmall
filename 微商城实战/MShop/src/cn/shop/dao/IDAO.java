...
/**
 * 定义公共的DAO操作接口标准，基本的功能包括：增加、修改全部、删除数据、根据编号查询、分页显示、数据统计
 * @author M
...
public interface IDAO<K,V> {
	 ...
	 * @return		数据删除成功返回true（删除的数据个数与要删除的数据个数相同），否则返回false
	 * @throws Exception	SQL执行异常
	 */
	 ...
	 * @param column 每页显示的数据行数
	 * @param keyWord 要进行模糊查询的数据列
