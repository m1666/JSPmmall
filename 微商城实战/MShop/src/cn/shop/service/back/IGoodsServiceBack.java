...
public interface IGoodsServiceBack {
    /**
     * 商品增加前的数据查询操作，要查询出所有的栏目信息：<br>
     *     <li>调用ITemDAO.faindAll()方法查询出全部的分类</li>
     * @return 数据以Map集合形式返回，包含有如下内容：<br>
     *     <li>key = allItems、value = IItemDAO.findAll()</li>
     * @throws Exception
     */
    public Map<String,Object> insertPre() throws Exception ;

    /**
     * 商品增加操作，增加的时候调用IGoodsDAO.doCreat()方法
     ...
     *     <li>调用IGoodsDAO.findAll()方法查询全部的商品信息返回值</li>
     *     <li>调用IGoodsDAO.getAllCount()方法统计全部数据量返回值</li>
     * @param currentPage
     * @param lineSize
     * @param column
     * @param keyWord
     * @return 以Map集合返回，包括如下内容：<br>
     *     <li>key = allGoods、value = IGoodsDAO.findAllSplit()返回值</li>
     *     <li>key = goodsCount、value = IGoodsDAO.getAllCount()返回值</li>
     * @throws Exception
     */
    ...
    /**
     * 商品修改前的数据查询操作，要查询出所有的栏目信息：<br>
     *     <li>调用ITemDAO.faindAll()方法查询出全部的分类</li>
     *     <li>调用IGoodsDAO.faindById()方法查询出全部的分类</li>
     * @return 数据以Map集合形式返回，包含有如下内容：<br>
