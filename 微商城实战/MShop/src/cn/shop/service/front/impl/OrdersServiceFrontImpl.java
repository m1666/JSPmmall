...
import cn.shop.exception.EmptyShopcarException;
import cn.shop.exception.UnCompleteMemberInfomrationException;
import cn.shop.exception.UnEnoughAmountException;
import cn.shop.factory.DAOFactory;
import cn.shop.service.front.IOrdersServiceFront;
import cn.shop.vo.Details;
...
public class OrdersServiceFrontImpl implements IOrdersServiceFront {
    ...
    public boolean insert(String mid) throws UnCompleteMemberInfomrationException, UnEnoughAmountException, EmptyShopcarException, SQLException {
        ...
        try {
            ...
            orders.setPay(pay);
            flag = DAOFactory.getIOrdersDAOInstance(this.dbc.getConnection()).doCreatOrders(orders);
