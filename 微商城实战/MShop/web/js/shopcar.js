...
window.onload = function () { // 在页面加载完之后进行统计计算
    document.getElementById("result").innerHTML = "<font color='FF0000'>" + "总金额" + allPrice + "</font>" ;
}
...
function calGoods(gid) {
    ...
    document.getElementById("cal-" + gid).innerHTML ="<font color='FF0000'>" + (price * count ) + "</font>" ;
